                ...
                <div className="flex m-5 md:mt-10 justify-center ">
                    <div className="flex flex-col justify-center text-3xl sm:text-4xl m-5 md:m-20 space-y-6">
                        ...
                        <div className="flex flex-row justify-evenly">
                            ...
                            <a target="_blank" rel="noopener" href="https://github.com/trivedip"><div className="sr-only">Click to visite my github profile</div><FaGithub/></a>
                            <a target="_blank" rel="noopener" href="https://www.linkedin.com/in/trivedipriyank/"><div className="sr-only">Click to connect with me on linked-in </div><FaLinkedin/></a>
                        </div>
                    </div>
                </div>
