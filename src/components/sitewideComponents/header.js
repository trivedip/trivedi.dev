...
function Header() {   
    ...
    return(
        <>
                <div className="z-30">
                    <span className="sm:hidden absolute right-0 py-12 z-50 max-w-screen-xl focus:outline-none" onClick={toggleMenu}>
                        <BiMenu className="w-8 h-8" style={{transform:'scale(1.8)'}} />
                    </span>
                </div>
                <div className={menu ? "m-auto px-3 mt-16 sm:px-12 md:px-20 max-w-screen-xl":"container m-auto max-w-screen-xl fixer z-30"}>
