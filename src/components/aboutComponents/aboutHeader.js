        ...
        <span className="flex flex-col md:flex-row space-y-10 md:space-y-0 flex-wrap relative z-30 max-w-screen-xl m-auto" >          
          ...
          <div className="justify-end" style={{flexBasis:'66%',flexShrink:'1'}} >
            <div className="flex flex-col md:ml-20 text-xl justify-end">
              ...
              <div className="justify-end ">
              Hi I am <p>Priyank Trivedi</p>, I am Master’s of Computer Science Graduate. I am a programmer, designer, and a big-time foodie. I was born in the small town of India, where I pursued my bachelor’s degree, currently I dwell in beautiful city of Austin, Texas.
              <br/><br/>
