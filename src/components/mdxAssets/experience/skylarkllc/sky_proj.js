            ...
            {/* <div className="justify-end" > */}
              <div className="justify-end" style={{flexBasis:'55%',flexShrink:'1'}} >
                <div className="flex flex-col md:mr-20 text-xl justify-end">
                  <div className="justify-end ">
                  My role at TrackMyShuttle was mainly to develop Machine Learning algorithm for accurate ETA calculations and generate visualization tool for geo coordinate data as well as metadata. 
                  As I have previously worked with the company's founder before my role also grew into helping make business decisions regarding evaluation of third party software solutions which might be integrated into the current technology stack.
                  <br/>
