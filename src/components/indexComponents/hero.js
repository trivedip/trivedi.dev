        ...
        <div className="mt-12 sm:mt-2 flex flex-col-reverse lg:flex-row items-center lg:justify-between lg:space-x-6">
            <div className="mt-12 sm:mt-2 flex flex-col-reverse lg:flex-row items-center lg:justify-between lg:space-x-6">
                <div className="mt-12 lg:mt-0 max-w-4xl text-3xl sm:text-4xl text-primary font-semibold sm:text-left md:text-center lg:text-left">
                    ...
                    <a className="my-3 p-1 text-lg" style={{border:'1px solid var(--color-gray700)'}}>Recent Work <GrLinkDown style={{display:'inline-block',transform:'scale()',marginTop:'-4px'}}/></a>    
                    <Link to="/about/" className="my-3 md:mx-5 p-1 text-lg" style={{border:'1px solid var(--color-gray700)'}}>Lean More About Me & Résumé <GrFormNextLink style={{display:'inline-block',transform:'scale(1.3)',marginTop:'-4px'}}/></Link>    
                </div>
